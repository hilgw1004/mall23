...
- delivery
```
 http :8088/deliveries id="id" orderId="orderId" productId="productId" productName="productName" customerId="customerId" adddress="adddress" status="status" 
```
- product
```
